...
namespace MySingleView {
	...
	public partial class A {
		[Register("BBBBB")]
		private partial class B : NSObject {
			public B(NativeHandle nativeHandle) : base(nativeHandle) {}
			...
			[Export("blahWithRefX:")]
			public int Blah(ref int x) {
				// ...
				return x;
			}

			[Export("blahWithOutX:")]
			public long Blah(out long w) {
				// ...
				w = 10;
				return w;
			}
			...
			public B Blah(C<B> b) {
				// ...
				return new B(new NativeHandle(IntPtr.Zero));
			}

			[Export("staticBlah:")]
			public static void StaticBlah(IntPtr y) {
				// ...
			}
			...
			// {
			// 	[Export("property2")] get;
			// 	[Export("property2:")] set;
			// }
		}
		
		private partial class C<T> : NSObject where T : NSObject
		{
			[Export("blah:")]
			public void Blah(bool z) {
				// ...
			}
		}
	}
	...
	// 			Assert.True (Messaging.bool_objc_msgSend_IntPtr (obj.Handle, Selector.GetHandle ("conformsToProtocol:"), Runtime.GetProtocol ("NSObject")));
	// 		}
	// 	}
	...
	// 			Assert.True (Messaging.bool_objc_msgSend_IntPtr (obj.Handle, Selector.GetHandle ("conformsToProtocol:"), Runtime.GetProtocol ("NSCoding")));
	// 			Assert.False (Messaging.bool_objc_msgSend_IntPtr (obj.Handle, Selector.GetHandle ("conformsToProtocol:"), Runtime.GetProtocol ("NSCopying")));
	// 		}
	...
	// 		Assert.True (Messaging.bool_objc_msgSend_IntPtr (Class.GetHandle (typeof (MyProtocolImplementation)), Selector.GetHandle ("conformsToProtocol:"), Runtime.GetProtocol (iProtocol)), "Interface/IProtocol");
	// 		Assert.True (Messaging.bool_objc_msgSend_IntPtr (Class.GetHandle (typeof (Test24970)), Selector.GetHandle ("conformsToProtocol:"), Protocol.GetHandle ("UIApplicationDelegate")), "UIApplicationDelegate/17669");
	// 		// We don't support [Adopts] (yet at least).
	// 		Assert.True (Messaging.bool_objc_msgSend_IntPtr (Class.GetHandle (typeof (ConformsToProtocolTestClass)), Selector.GetHandle ("conformsToProtocol:"), Runtime.GetProtocol ("NSCoding")), "Adopts/ConformsToProtocolTestClass");
	// 	}
	...
	// 		[DllImport ("/usr/lib/libobjc.dylib", EntryPoint = "objc_msgSend")]
	// 		public extern static int int_objc_msgSend (IntPtr ptr, IntPtr sel);
	// 		[DllImport ("/usr/lib/libobjc.dylib", EntryPoint = "objc_msgSend")]
	// 		public extern static void void_objc_msgSend_int (IntPtr ptr, IntPtr sel, int p0);
	// 	}
	...
	// 		public static void False (bool x, [CallerArgumentExpression("x")] string? msg = null) {
	// 			if (x) {
	// 				Console.WriteLine ($"[FAIL] {msg}");
	// 			} else {
	// 				// Console.WriteLine ($"[OK] {msg}");
	...
	// 		public static void True (bool x, [CallerArgumentExpression("x")] string? msg = null) {
	// 			if (!x) {
	// 				Console.WriteLine ($"[FAIL] {msg}");
	// 			} else {
	// 				// Console.WriteLine ($"[OK] {msg}");
	...
	// 		public static void DoesNotThrow (Action a, string msg) {
	// 			try {
	// 				a ();
	// 			} catch (Exception e) {
	// 				Console.WriteLine ($"[FAIL] {msg}: {e}");
	// 			}
	// 		}
	// 	}
	...
	// partial class Test24970 : UIApplicationDelegate {
	...
	// partial class AnyT<T> : NSObject { }

	// [Adopts ("NSCoding")]
	// partial class ConformsToProtocolTestClass : NSObject {
	// 	public ConformsToProtocolTestClass() {}
	// 	public ConformsToProtocolTestClass (NativeHandle handle) : base (handle) { }
	// }

	// [Adopts ("NSCoding")]
	// partial class ConformsToProtocolTestClass<T> : NSObject where T : NSObject { }
	...
	// partial class MyProtocolImplementation : NSObject, IProtocol {
	// 	public int Foo ()
	// 	{
	// 		return 31415;
	// 	}
