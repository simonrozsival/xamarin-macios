...
#pragma warning restore CS8618
		...
		public static NativeHandle GetHandle<T> ()
		{
			// TODO we could use virtual interface methods on T if it has some basic interface (INativeObject?)
			return GetHandle (typeof (T));
		}

		public static NativeHandle GetHandle (Type type)
		{
			// TODO this is necessary for example for AppKit.NSCollectionView.RegisterClassForItem
			// how can we implement this without the registrar?
		...
		{
			// TODO is this used for managed static registrar? what for?
